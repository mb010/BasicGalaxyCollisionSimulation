...
#velFactor 		= np.asarray([[1.32],[1.32],[0.51]],dtype=np.float64)
...
zangle = np.array([-20.*np.pi/180,	0.*np.pi/180,			0*np.pi/180.],dtype=np.float64)#[rad]#Must have length >= NumberOfGalaxies , Angle around the z angle around which to rotate
